# Next.js 14 BhimKatta

<!-- GitHub badges -->

[![Latest release](https://img.shields.io/github/v/release/ladunjexa/nextjs14-BhimKatta?label=Latest%20release&style=social)](https://github.com/ladunjexa/nextjs14-BhimKatta/releases/tag/v0.1.0)
[![Stars](https://img.shields.io/github/stars/ladunjexa/nextjs14-BhimKatta?style=social)](https://github.com/ladunjexa/nextjs14-BhimKatta/stargazers)
[![Fork](https://img.shields.io/github/forks/ladunjexa/nextjs14-BhimKatta?style=social)](https://github.com/ladunjexa/nextjs14-BhimKatta/forks)
[![GitHub commits](https://img.shields.io/github/commit-activity/t/ladunjexa/nextjs14-BhimKatta?style=social&logo=github)](https://github.com/ladunjexa/nextjs14-BhimKatta/commits)
[![Pull requests](https://img.shields.io/github/issues-pr/ladunjexa/nextjs14-BhimKatta?style=social&logo=github)](https://github.com/ladunjexa/nextjs14-BhimKatta/pulls)

![demo](https://i.ibb.co/x7FChRP/Thumbnail.jpg)

[![ladunjexa](https://custom-icon-badges.demolab.com/badge/made%20by%20-ladunjexa-556bf2?logo=github&logoColor=white&labelColor=101827)](https://github.com/luadnjexa)
[![License](https://img.shields.io/github/license/ladunjexa/nextjs14-BhimKatta?color=dddddd&labelColor=000000)](https://github.com/ladunjexa/nextjs14-BhimKatta/blob/main/LICENSE)
[![Top Language](https://img.shields.io/github/languages/top/ladunjexa/nextjs14-BhimKatta?logo=github&logoColor=%23007ACC&label=TypeScript)](https://www.typescriptlang.org/)
[![Contributors](https://img.shields.io/github/contributors/ladunjexa/nextjs14-BhimKatta?style=flat&color=orange&label=Contributors)](https://github.com/ladunjexa/nextjs14-BhimKatta/graphs/contributors)
![Release](https://img.shields.io/github/release/ladunjexa/nextjs14-BhimKatta.svg)
![PRs](https://img.shields.io/badge/PRs-welcome-ff69b4.svg?style=shields)
![deployment](https://img.shields.io/github/deployments/ladunjexa/nextjs14-BhimKatta/Production?logo=vercel&label=Website)
[![Known Vulnerabilities](https://snyk.io/test/github/ladunjexa/nextjs14-BhimKatta/badge.svg)](https://snyk.io/test/github/ladunjexa/nextjs14-BhimKatta)

## 🌐 Live Demo

Explore the live demonstration of the project: [nextjs14-BhimKatta](https://nextjs14-BhimKatta.vercel.app/)

## 📝 Description

**BhimKatta** is a complex Q&A platform for developers to ask questions, share knowledge, and learn from each other. It is built with Next.js, Tailwind CSS, Clerk, MongoDB, and more.
...
<details><summary><b>BhimKatta</b> is built using the following technologies:</summary>
...
```bash
git clone https://github.com/ladunjexa/nextjs14-BhimKatta.git
```
...
**BhimKatta** uses [Clerk](https://clerk.com), [TinyMCE](https://uploadthing.com/), [RapidAPI](https://rapidapi.com), [OpenAI API](https://openai.com/blog/openai-api) and [MongoDB](https://mongodb.com) as external services. You need to create an account on each of these services and get the required credentials to run the app.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fladunjexa%2Fnextjs14-BhimKatta)

#### Deploy on Netlify

You can also deploy this Next.js app with [Netlify](https://www.netlify.com/).

[![Deploy with Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ladunjexa/nextjs14-BhimKatta)

Check out [Next.js deployment documentation](https://nextjs.org/docs/deployment) for more details.

## 🔧 Contributing

[![contributors](https://contrib.rocks/image?repo=ladunjexa/nextjs14-BhimKatta)](https://github.com/ladunjexa/nextjs14-BhimKatta/graphs/contributors)
...
If you find a bug (failure of a module to execute its intended function), kindly open an issue [here](https://github.com/ladunjexa/nextjs14-BhimKatta/issues/new) by including the issue with a title and clear description.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/ladunjexa/nextjs14-BhimKatta/issues/new). Please include sample queries and their corresponding results.
